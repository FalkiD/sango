...
HD_PWD='C:/Users/jlcooper/Documents/Ampleon/s4x7/Sango_GitHub/sango/FPGA/Coop/S4/S4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s4.tcl

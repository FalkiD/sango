...
# Clock signal
# Our ckt uses 100MHz master clock from synthesizer
#For Arty board testing, generate clocks here:
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {CLK}];

#Switches

# for use w/Coops uart debugger
...
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { RGB_GRN[0] }]; #RGB0_Green }]; #IO_L19N_T3_VREF_35 Sch=led0_g
...
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { RGB_GRN[1] }]; #RGB1_Green }]; #IO_L21P_T3_DQS_35 Sch=led1_g
...
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { RGB_GRN[2] }]; #RGB2_Green }]; #IO_L22N_T3_35 Sch=led2_g
...
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { RGB_GRN[3] }]; #RGB3_Green }]; #IO_L24P_T3_35 Sch=led3_g
...
# from Coop's debugging uart module
...
# use btn 1 for RESET
###set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { RST }]; #IO_L6N_T0_VREF_16 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { MSYN_SSN }]; #ja[1] }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { RSYN_SSN }]; #ja[2] }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { FR_SSN }]; #ja[3] }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { DDS_SSN }]; #ja[4] }]; #IO_L6P_T0_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { MBW_SSN }]; #ja[7] }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { SYN_MOSI }]; #ja[8] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { SYN_MISO }]; #ja[9] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
# original file from Digilient had E18 here, manual shows K16, K16 works on Arty
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { SYN_SCLK }]; #ja[10] }]; #IO_L11P_T1_SRCC_15 Sch=ja[10]
...
##Pmod Header JC
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets MMCCLK_IBUF]
...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { MMCCMD }]; #jc[3] }]; #IO_L21P_T3_DQS_14 Sch=jc[3]
...
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { MMCCLK }]; #jc[9] }]; #IO_L23P_T3_A03_D19_14 Sch=jc[9]
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { jc[10] }]; #IO_L23N_T3_A02_D18_14 Sch=jc[10]


##Pmod Header JD

# From Coop's uart1 module
...
#set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { DAT[1] }]; #jd[1] }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { DAT[7] }]; #jd[2] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
#set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { DAT[5] }]; #jd[3] }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { DAT[3] }]; #jd[4] }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
#set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { DAT[0] }]; #jd[7] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
#set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { DAT[6] }]; #jd[8] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { DAT[4] }]; #jd[9] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
#set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { DAT[2] }]; #jd[10] }]; #IO_L15N_T2_DQS_35 Sch=jd[10]

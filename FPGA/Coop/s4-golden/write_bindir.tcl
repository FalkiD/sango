...
puts $BITFILE
file copy -force $BITFILE $PRJDIR/bin/s4-golden.bit
set PRMFILE $PRJDIR/bin/*.prm
puts $PRMFILE
file delete -force $PRMFILE
write_cfgmem -format mcs -size 128 -interface SPIx4 -loadbit "up 0x00000000 $PRJDIR/bin/s4-golden.bit " -force -file "$PRJDIR/bin/s4-golden.mcs"

...
# NOTE:  FPGA will use FPGA_MCLK for clock input on etch rev A boards
#
#set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports CLK]
#create_clock -period 10.000 -name FPGA_CLK -waveform {0.000 5.000} -add [get_ports CLK]
#set_property -dict {PACKAGE_PIN C4 IOSTANDARD LVCMOS33} [get_ports CLK]
#create_clock -period 10.000 -name FPGA_CLKn -waveform {0.000 5.000} -add [get_ports CLK]
...
set property PULLUP [get_ports {VGA_SSn}]
...
set property PULLUP [get_ports {DDS_SSn}]
...
set property PULLUP [get_ports {SYN_SSn}]
